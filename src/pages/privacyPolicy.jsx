export default function PrivacyPolicy() {
  return (
    <>
      ...
      <p>Last updated: November 02, 2024</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Cachano, Calle Alfredo
            Marquerie, Madrid.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Cachano, accessible from{' '}
            <a
              href="https://cachano.vercel.app/login"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://cachano.vercel.app/login
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: nachoo10domingo@gmail.com</li>
      </ul>
    </>
  );
}
